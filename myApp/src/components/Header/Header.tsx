              ...
              <ul className="navbar-nav col-12">
                ...
                <li className="nav-item active">
                  <Link to="/contacts" onClick={() => setTitle("Контакты")}>
                    <div className="nav-link ml-3">
                      Контакты <span className="sr-only">(current)</span>
                    </div>
                  </Link>
                </li>
                <li className="vertical ml-3"></li>
                <li className="nav-item active">
                  <Link to="/">
                    <div className="nav-link ml-3">
                      Счета <span className="sr-only">(current)</span>
                    </div>
                  </Link>
                </li>
                <li className="vertical ml-3"></li>
                <li className="nav-item active">
                  <Link to="/">
                    <div className="nav-link ml-3">
                      Платежи <span className="sr-only">(current)</span>
                    </div>
                  </Link>
                </li>
                <li className="vertical ml-3"></li>
                <li className="nav-item active">
                  <Link to="/">
                    <div className="nav-link ml-3">
                      Переводы <span className="sr-only">(current)</span>
                    </div>
                  </Link>
                </li>
                <li className="vertical ml-3"></li>
                <li className="nav-item active">
                  <Link to="/">
                    <div className="nav-link ml-3">
                      Заявка <span className="sr-only">(current)</span>
                    </div>
                  </Link>
                </li>
              </ul>
